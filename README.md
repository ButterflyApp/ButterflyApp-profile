...
To optimize the profile application for production, run:
...
[Service Discovery and Configuration with Consul]: http://www.jhipster.tech/documentation-archive/v4.9.0/microservices-architecture/#consul
